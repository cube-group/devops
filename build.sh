...
build linux/arm64,linux/amd64 cubegroup/devops $path/dockerfiles/devops/Dockerfile $path
build linux/arm64,linux/amd64 cubegroup/devops-java $path/dockerfiles/devops-java/Dockerfile $path