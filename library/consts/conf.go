...
const (
	...
	DB_DATABASE      = "DB_DATABASE"      //mysql database
	DB_POOL_MAX_OPEN = "DB_POOL_MAX_OPEN" //mysql pool max open
	...
	WEB_PORT         = "WEB_PORT"         //gin server address port
	WEB_PORT_TLS     = "WEB_PORT_TLS"     //gin server address port tls
)
