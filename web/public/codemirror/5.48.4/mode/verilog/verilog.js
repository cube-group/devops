...
CodeMirror.defineMode("verilog", function(config, parserConfig) {
  ...
  var keywords = words(
    ...
    "table tagged job this throughout time timeprecision timeunit tran tranif0 tranif1 tri tri0 tri1 triand trior " +
  ...
  */
  ...
  // E.cluster. "job" => "endtask"
  var blockKeywords = words(
    "case checker class clocking config function generate interface module package " +
    "primitive program property specify sequence table job"
  );
  ...
  return {
    ...
    token: function(stream, state) {
      ...
      if (curPunc == ctx.type) {
        ...
        } else if (curKeyword == "job" && ctx && ctx.type == "statement") {
          // Same thing for job
        } else {
